...
# {username:{id: passwort, einkommen: ,fixkosten: , ausgaben: {Fleisch: ,ObstUndGem?se: ,Milchprodukte: , Auto: , Sonderausgaben, Anderes: }}}
...
class Regestrierung_Popup(Popup):
    ...
    def anmelden(self):
        ...
        if self.username_1.text == "":
            ...
            # anmeldung ?berpr?ft ob name schon in csv
            with open("Finanz - Excel.csv", "r") as file:
                for line in file:
                    line_splitted = line.strip().split(",")
...
class Daten_sammlung:
    ...
    def add_user(self, username, passwort, date):
        ...
        self.dictionary = {"Username": x, "Passwort": y, "Datum": date, "Einkommen": 0,
                           ...
                           "Backwaren": 0, "Fleisch": 0, "Wurst": 0, "ObstUndGem.": 0, "Milchprodukte": 0,
                           "Drinks": 0,
                           "Snacks": 0, "Sonstiges": 0, "Kosmetik": 0, "Luxus": 0, "Auto": 0, "weggeworfen": 0,
                           "Eingabe-Datum": 0}
        ...
        with open("Finanz - Excel.csv", "a", newline="") as csvfile:
            fieldnames = ["Username", "Passwort", "Datum", "Einkommen", "Fixkosten", "Ausgaben", "Lebensmittel",
                          "Backwaren",
                          "Fleisch", "Wurst", "ObstUndGem.", "Milchprodukte", "Drinks", "Snacks", "Sonstiges",
                          "Kosmetik", "Luxus", "Auto", "weggeworfen", "Eingabe-Datum"]
                ...
                if row[0] == self.username:
                    ...
                    if row[2] != self.datum:
                        if row[2] == "Datum":
                            ...
                            self.i += 1
                            # datum ?bernahme / neue Reihe pro tag
...
class Ausgaben_Popup(Popup):
    ...
    def btn_hinzufuegen(self, name):
        ...
        fieldnames = ["Username", "Passwort", "Datum", "Einkommen", "Fixkosten", "Ausgaben", "Lebensmittel",
                      "Backwaren",
                      "Fleisch", "Wurst", "Obst und Gem.", "Milchprodukte", "Drinks", "Snacks", "Sonstiges",
                      "Kosmetik / Haushalt", "Sonderausgaben", "Auto", "weggeworfen"]
        ...
        try:
            ...
            self.menge_hinzugefuegt.text = "+ " + str(self.menge) + " Euro"
